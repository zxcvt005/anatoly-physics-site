...
const checklistGroups: ChecklistGroup[] = [
  {
    ...
    activities: [
      ...
      'Нарисовать мелом на асфальте',
      'Сходить в парк атракционов',
    ],
  },
  {
    points: 10,
    ...
    activities: [
      ...
      'Сделать колесо',
      'Найти гриб прикрепленный к дереву',
    ],
  },
  {
    points: 15,
    ...
    activities: [
      ...
      'Простоять на руках не менее 3 секунд',
      'Сфотографировать стрекозу',
      'Сделать венок из одуванчиков',
      'Сфотографировать ежика',
      'Поплавать на сапборде',
    ],
  },
];
